            ...
            if (nextPoint == null) {
                ...
                if (space != null && space.equals(TreasureChest.CHARACTER)) {
                    ...
                    switch (this.map.get(nextPoint)) {
                        case TreasureChest.CHEST_TRESURE_CHARACTER ->
                            sucess++;
                        case TreasureChest.CHEST_TRAP_CHARACTER ->
                            trap++;
                        case TreasureChest.CHEST_EMPTY_CHARACTER ->
                            empty++;
                    }
                    break;
                }/*  else if (space != null && space.equals(MapOfTreasure.CHARACTER)) {
                    System.out.println("Encontroou o mapa");
                }  */else {
